...
public class ChoixHardLevels extends BasicGameState{
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException { 
    	...
    	this.boutonLvl1 = new Image("graphisme/Images/choix/ChoixHardLevels/choix51.png");
    	this.boutonLvl2 = new Image("graphisme/Images/choix/ChoixHardLevels/choix52.png");
    	this.boutonLvl3 = new Image("graphisme/Images/choix/ChoixHardLevels/choix53.png");
    	this.boutonLvl4 = new Image("graphisme/Images/choix/ChoixHardLevels/choix54.png");
    	this.boutonLvl5 = new Image("graphisme/Images/choix/ChoixHardLevels/choix55.png");
    ...
    {	
    	...
    	positionX = (container.getWidth()-(boutonLvl4.getWidth()+boutonLvl5.getWidth()+ecartLargeur))/2;
